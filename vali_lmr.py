...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 21:59:39 2019
...
# filepath=Dataset('/Users/lxy/Desktop/research/ENSO/data/LMR/pdsi_MCruns_ensemble_mean_LMRv2.0.nc')
# pdsi=filepath.variables['pdsi']
# PDSI=np.mean(pdsi,1)
# 
...
# year_had=np.arange(1854,2020)
# 
# sst_had=np.zeros((166,89,180))
# 
# #annual mean (Jan-Dec)
...
# lonhad=filepath3.variables['longitude']
# lonhad=np.ma.getdata(lonhad)
# year_had=np.arange(1850,2019)
# 
# sst_had=np.zeros((169,36,72))
# 
# #annual mean (Jan-Dec)
...
sstael_hadmean=np.mean(sstael_had,0)
...
sstala_hadmean=np.mean(sstala_had,0)
...
plt.title('LMRv2.1 El Nino',fontsize=8)
...
#cbar.ax.tick_params(labelsize=5)
plt.title('HadISST El Nino',fontsize=8)
...
cbar.ax.tick_params(labelsize=5)
plt.title('HadISST-LMRv2.1 El Nino',fontsize=8)
...
#cbar.ax.tick_params(labelsize=5)
plt.title('LMRv2.1 La Nina',fontsize=8)
...
#cbar.ax.tick_params(labelsize=5)
plt.title('HadISST La Nina',fontsize=8)
...
cbar.ax.tick_params(labelsize=5)
plt.title('HadISST-LMRv2.1 La Nina',fontsize=8)
...
plt.plot(year_had[(year_had>=1900)&(year_had<=1999)], 
                  ...
                  label='LMRv2.1 (r='+str(round(a,2))+' p<0.005)')
plt.plot(year_had[(year_had>=1900)&(year_had<=1999)], 
                  nino34_std_had[(year_had>=1900)&(year_had<=1999)],label='HadISST')
plt.ylim(-3,3)
...
#fig.savefig('/Users/lxy/Desktop/research/ENSO/cp_ep/validation/ENSO/newEl&Lalmr21.png',dpi=600)
...
cbar.ax.tick_params(labelsize=5)
plt.title('NADA-LMRv2.1 El Nino',fontsize=8)
...
cbar = m.colorbar(ax3,shrink=0.8,ticks=[-3,-2,-1,0,1,2,3])
cbar.ax.tick_params(labelsize=5)
plt.title('NADA-LMRv2.1 La Nina',fontsize=8)


plt.tight_layout()

#fig.savefig('/Users/lxy/Desktop/research/ENSO/cp_ep/validation/ENSO/newpdsilmr21.png',dpi=600)
